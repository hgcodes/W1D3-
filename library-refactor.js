...
printPlaylists = function () {
  ...
  console.log(this.playlists[id].id + ": " + this.playlists[id].name + " - " +
    this.playlists[id].tracks.length + " tracks");
  }
}
...
printTracks = function () {
  ...
  console.log(this.tracks[id].id + ": " + this.tracks[id].name + " by " +
    this.tracks[id].artist + " " + "(" + this.tracks[id].album + ")");
  }
}
